...
# A star may carry a TESS light curve (variability + coherence Q) and/or a
# JWST/HST spectrum ("spectrum": {collection, instrument}). Photometry
# comes from TESS; spectroscopy from JWST/HST via db-adjacent
# pipeline.spectra. period_days=None marks a spectrum-focused star with no
# clean TESS variability period.
WR_STARS = [
    ...
    {"name": "WR 6 (EZ CMa)", "ident": "HD 50896", "teff": 89000,
     ...
     "spectrum": {"collection": "HST", "instrument": "HRS/2"}},
    {"name": "WR 136", "ident": "HD 192163", "teff": 70000,
     "radius": 4.9, "period_days": 4.5,
     "note": "WN6 — clumped wind variability",
     "spectrum": {"collection": "HST", "instrument": "STIS/NUV-MAMA"}},
    {"name": "WR 140", "ident": "HD 193793", "teff": 70000,
     "radius": 3.0, "period_days": None,
     "note": "WC7+O5 colliding-wind binary — JWST mid-IR dust spectrum",
     "spectrum": {"collection": "JWST", "instrument": "MIRI/SLIT"}},
    {"name": "gamma Vel (WR 11)", "ident": "HD 68273", "teff": 57000,
     "radius": 6.0, "period_days": None,
     "note": "WC8+O7.5 — brightest WR, HST UV spectrum",
     "spectrum": {"collection": "HST", "instrument": "STIS/CCD"}},
]
